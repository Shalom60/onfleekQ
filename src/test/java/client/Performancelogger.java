...
//        logLaunchTime();
        ...
        logCpuUsage("com.onfleekq.client");
        logFPS("com.onfleekq.client");
        logBatteryUsage("com.onfleekq.client");
    ...
    private void logCpuUsage(String packageName) {
        ...
        try {
            String command = "adb shell top -n 1 | findstr com.onfleekq.client"; //onfleekq is shortened cos of output width
    ...
    public void logBatteryUsage(String packageName) {
            ...
            String uid = getAppUid("com.onfleekq.client");
            if (uid.isEmpty()) {
